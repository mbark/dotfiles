 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   | ctrl | l-fn | swe  | alt  | gui  |                                       | bspc | alt  |      |      | ctrl |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        |      |      |       |      |      |
 *                                 ,------|------|------|       |------+------+------.
...
[_QWERTY] = LAYOUT_ergodox(
        // left hand
            NAV, KC_1,    KC_2,    KC_3,    KC_4,    KC_5, KC_LPRN,
       ...
       ESC_NAV,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,
        ...
        KC_BSPC,   KC_RALT, _______, _______, KC_RCTL,
...
[_SYMBOL] = LAYOUT_ergodox(
       ...
       // right hand
       _______, _______, _______, _______, _______, _______, _______,
       _______, KC_LPRN, KC_7,    KC_8,    KC_9,    KC_RPRN, KC_MINS,
                KC_LBRC, KC_4,    KC_5,    KC_6,    KC_RBRC, KC_BSLS,
       _______, KC_LCBR, KC_1,    KC_2,    KC_3,    KC_RCBR, KC_GRV,
                         _______, _______, _______, _______, _______,
 ...
 * |        |      |      |      |      |      |      |           |      |      |  F7  |  F8  |  F9  | F10  |        |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |        | shift| ctrl | alt  | cmd  |      |------|           |------|      |  F4  |  F5  |  F6  | F11  |        |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |        |      |      |      |      |      |      |           |      |      |  F1  |  F2  |  F3  | F12  |        |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |      | l-fn |      |      |      |                                       |      |      |      |      |      |
...
[_FN] = LAYOUT_ergodox(
    ...
    _______, _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______, _______,
    _______, KC_LSFT, KC_LCTL, KC_LALT, KC_LCMD, _______,
    _______, _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______,
